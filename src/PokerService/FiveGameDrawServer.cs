...
{
    /// <summary>
    /// A helper based implementation of the five game draw server.
    /// </summary>
    public class FiveGameDrawServer : BaseFiveCardEngine
    {
        // the helper is used to communicate and run the game.
        private IFiveCardEngineHelper helper;

        /// <summary>
        /// 	<para>Initializes an instance of the <see cref="FiveGameDrawServer"/> class.</para>
        /// </summary>
        /// <param name="helper">The helper which provides the input/output operations
        /// </param>
        public FiveGameDrawServer(IFiveCardEngineHelper helper)
        {
            this.helper = helper;
        }
        ...
        protected override void NotifyPlayerNewCards(Player curPlayer)
        {
            base.NotifyPlayerNewCards(curPlayer);
            helper.NotifyPlayerNewCards(curPlayer);
        }

        /// <summary>
        /// Called by the engine after the drawing round completes.
        /// </summary>
        protected override void NotifyDrawComplete()
        {
            helper.NotifyDrawComplete();
        }
        ...
        /// <remarks>
        /// In a <see cref="BaseEngine.TournamentMode"/> the <see cref="BaseEngine.Ante"/> 
        /// and the <see cref="BaseEngine.SmallRaise"/> are increased.
        /// </remarks>
